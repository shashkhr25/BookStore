...
public class CreateCategoryTests {
	...
	public void testCreateCategoryNull() throws Exception {
		...
		mockMvc.perform(requestBuilder).andExpect(MockMvcResultMatchers.content()
                .string("{\"message\":\"Cannot add empty category\"}")).andDo(MockMvcResultHandlers.print());
	}
	...
	public void testCreateCategoryExists() throws Exception {
		...
		mockMvc.perform(requestBuilder).andExpect(MockMvcResultMatchers.content()
                .string("{\"message\":\"Category already exists\"}")).andDo(MockMvcResultHandlers.print());
	}
	...
	public void testCreateCategoryBotValidated() throws Exception {
		...
		mockMvc.perform(requestBuilder).andExpect(MockMvcResultMatchers.content()
                .string("{\"message\":\"Category name cannot be less than 5 characters and more than 30\"}")).andDo(MockMvcResultHandlers.print());
	} 
	...
	public void testCreateCategoryAdded() throws Exception {
		...
		mockMvc.perform(requestBuilder).andExpect(MockMvcResultMatchers.content()
                .string("{\"message\":\"Category added\"}")).andDo(MockMvcResultHandlers.print());
	}
